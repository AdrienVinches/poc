...
var weemo_box = function() {
    var box = $('<div class="weemo_modal_box"><div class="weemo_modal_header"><button type="button" class="weemo_modal_close" >&times;</button><h3 class="weemo_modal_header_title">Weemo Driver Download</h3></div><div class="weemo_inner_modal_box"><p>WeemoDriver does not respond, please click to download and install the latest version.</p><br/><div class="weemo_download_button"><a class="weemo_download_button_link" href="'+ self.options.downloadUrl+'">Download</a></div></div><div class="weemo_footer"><a href="#" class="weemo_download_button_link btnClose">Close</a></div></div>');
